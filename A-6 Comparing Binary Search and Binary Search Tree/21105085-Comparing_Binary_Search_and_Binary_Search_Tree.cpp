...
/*
When all of the items in an array with n elements are entered into a binary search tree,
the space complexity of the tree is O(n), and the space complexity of the array is O(n).
*/

//ADITYA KANSAL 21105085